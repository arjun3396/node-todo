...
describe('GET /todos/:id', () => {
  ...
  it('should not return a todo doc crated by other user', (done) => {
    request(app)
...
describe('Patch /todos/:id', () => {
  ...
  it('Should clear completedAt todo is not completed', (done) => {
    var hexId = todos[1]._id.toHexString();
    var text = 'This should be new text two';
